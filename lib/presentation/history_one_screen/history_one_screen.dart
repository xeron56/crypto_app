...
import '../history_one_screen/widgets/octobertoday_item_widget.dart';
...
class HistoryOneScreen extends GetWidget<HistoryOneController> {
  const HistoryOneScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget _buildOctoberToday() {
    return Obx(
      () => GroupedListView<OctobertodayItemModel, String>(
        shrinkWrap: true,
        stickyHeaderBackgroundColor: Colors.transparent,
        elements:
            controller.historyOneModelObj.value.octobertodayItemList.value,
